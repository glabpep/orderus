...
PRODUTOS_PADRAO = [
    ...
    ("MOTS-C", "40 mg", 380, 380, 0, "Metabolismo", "🔥", True, "Peptídeo derivado da mitocôndria: regulador do metabolismo sistêmico via AMPK. | Mitochondria-derived peptide: regulates systemic metabolism through AMPK."),
    ...
    ("SERMORELIN", "10 mg", 220, 220, 0, "Hormônios", "💉", True, "Mimetiza o GHRH natural — melhora sono profundo e vitalidade. | Mimics natural GHRH — improves deep sleep and vitality."),
    ...
    ("ARA 290", "10 mg", 380, 380, 0, "Recuperação", "🩹", True, "Derivado da eritropoietina — dor neuropática e regeneração nervosa. | Erythropoietin derivative — neuropathic pain and nerve regeneration."),
    ...
    ("TIRZEPATIDE", "30 mg", 780, 780, 0, "Emagrecimento", "⚖️", True, "Agonista dual GIP/GLP-1 — supera a semaglutida na perda de peso. | Dual GIP/GLP-1 agonist — outperforms semaglutide for weight loss."),
    ("TIRZEPATIDE", "60 mg", 780, 780, 0, "Emagrecimento", "⚖️", True, "Agonista dual GIP/GLP-1 — supera a semaglutida na perda de peso. | Dual GIP/GLP-1 agonist — outperforms semaglutide for weight loss."),
    ...
    ("RETATRUTIDE", "30 mg", 940, 940, 0, "Emagrecimento", "⚖️", True, "Agonista triplo (GIP/GLP-1/GCGR) — perdas de peso >24%. | Triple agonist (GIP/GLP-1/GCGR) — weight loss above 24%."),
    ("RETATRUTIDE", "60 mg", 940, 940, 0, "Emagrecimento", "⚖️", True, "Agonista triplo (GIP/GLP-1/GCGR) — perdas de peso >24%. | Triple agonist (GIP/GLP-1/GCGR) — weight loss above 24%."),
